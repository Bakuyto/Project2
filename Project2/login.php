...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Assuming User_login stored procedure returns 'usertype' column, and you fetch the result
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        // // Debug: Check fetched row
        // var_dump($row);
        
        // Check if 'usertype' is present in the fetched row
